        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a onclick="javascript: return  confirm('Anda Yakin Hapus?')" <?php echo anchor('penduduk/hapus_data/' . $pnd['id_data'], '<div class=" btn btn-danger btn-sm"> <i class="fa fa-trash"> </i> </div>') ?></a>


                            <a href="<?php echo base_url('penduduk/edit_data/' . $pnd['id_data']) ?>" class=" btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Form Input Jumlah Penduduk</h4>
