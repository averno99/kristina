...
<div class="modal fade" id="newDataUserModal" tabindex="-1" aria-labelledby="newDataUserModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action=" <?= base_url('User/datauser'); ?> " method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="User nama" value="<?= set_value('nama'); ?>">
    ...
    <div class="modal fade" id="editModal<?php echo $du1['id']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('User/editdatauser/' . $du1['id']); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="User name" value="<?php echo $du1['nama']; ?>">
                        <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
    ...
    <div class="modal fade" id="hapusModal<?php echo $du1['id']; ?>" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('User/hapusdatauser/' . $du1['id']); ?>" method="post">
                    <div class="modal-body">
